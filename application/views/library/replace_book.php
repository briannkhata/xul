					...
					<div class="portlet box grey" style="border:1px solid #E5E5E5;">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?=base_url();?>book_rentout/replace" method="post" class="horizontal-form">
											<div class="form-body">
					...
					<input type="hidden" name="fine" class="form-control" value="<?=$this->M_book->get_price($book_id);?>" >
							...
							<input type="hidden" name="book_id" value="<?=$book_id;?>">
											...
											<div class="form-actions left">
                                                  ...
                                                  <?php }?>
												<button type="submit" class="btn default blue-stripe"> Replace</button>
