				...
				<div class="col-md-12">
					...
					<div class="portlet box grey" style="border:1px solid #E5E5E5;">
						...
						<?php
						  ...
						  $subject = $this->M_examination_paper->get_subject_id($examination_paper_id);
						...
						<div class="portlet-body">
							<table class="table well">
								...
								<tr>
									...
									<td><?=$this->M_examination_paper->get_examination_paper($examination_paper_id);?></td>
								</tr>
								<tr>
									<td>Total Marks</td>
...
<td><b><?=count($this->M_examination->get_examination_papers_marks1000($examination_id,$grade_level_id,$examination_id,$grade_level_id,$examination_paper_id));?></b> students</td>
								</tr>
							</table>
...
<?php foreach ($this->M_examination->get_examination_papers_marks1000($examination_id,$grade_level_id,$examination_paper_id) as $row):?>
							<tr>
								<td><?=$this->M_user->get_user($row['user_id']);?></td>
								<td><?=$this->M_user->get_gender($row['user_id']);?></td>
								<td><?=$row['mark_obtained'];?></td>
<td><?=$this->M_examination->get_subject_rankMARKSHEET($row['user_id'],$examination_id,$examination_paper_id,$grade_level_id);?></td>
						   ...
						   <a href="<?=base_url();?>examination/filter_examination4" class="btn default">Back</a>
