					...
					<div class="portlet box grey" style="border:1px solid #E5E5E5;">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?=base_url();?>arrear/save" method="post" class="horizontal-form">
											<div class="form-body">
												<br>
												<div class="row">
							...
							<option <?php if($year == $row['year']){ echo 'selected';}?> value="<?=$row['year'];?>"><?=$row['year'];?></option>
																<?php }?>
													</select>
														</div>
											...
											<div class="form-actions left">
												...
												<a href="<?=base_url();?>arrear" class="btn default green-stripe"> Back</a>
											</div>
										</form>
										<!-- END FORM-->
								</div>
