	...
	<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box grey" style="border:1px solid #E5E5E5;">
						...
						<form action="" method="post" id="formGraduate">
							...
							<?php foreach ($this->M_user->get_students_by_class2($grade_level_id,$academic_year_id) as $row){?>
							<tr>
								<td>
							...
							<center class="well no-print">
								...
								<button name="button" onclick="graduate()" class="btn default green-stripe">
								Graduate</button>
						
						   <a href="<?=base_url();?>user/graduate" class="btn default red-stripe">Back</a>
			...
			<script type="text/javascript">
				function graduate(){
					var formData = $('#formGraduate').serializeArray();
					$.ajax({
					    type : "POST",
					      url: '<?=base_url();?>user/graduate3',
					     data: formData,
					    dataType: "json",
					    success: function(data, textStatus, jqXHR){
					        alert('Students graduated Saved Successfully');
					        location.reload();
					    },
