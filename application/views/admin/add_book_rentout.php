					<?php $this->load->view('header');?>
						<div class="portlet box grey" style="border:1px solid #E5E5E5;">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?=base_url();?>book_rentout/save" method="post" class="horizontal-form">
											<div class="form-body">
												<br>
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input type="date" name="due_date" class="form-control" value="<?php if (!empty($due_date)){echo $due_date;}?>" >
														</div>
													</div>
