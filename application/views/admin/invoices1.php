              ...
              <div class="portlet box grey" style="border:1px solid #E5E5E5;">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?=base_url();?>charge/invoices2" method="post" class="horizontal-form">
											<div class="form-body">
												<br>
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<select class="form-control" name="charge_type_id" required="">
																<option disabled="" selected="">Select Option</option>
															<?php foreach ($this->M_charge_type->get_charge_types() as $row) {?>

																	<option value="<?=$row['charge_type_id'];?>">
																		<?=$row['charge_type'];?>
																	</option>
																<?php }?>
															</select>
