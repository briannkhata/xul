					...
					<div class="portlet box grey" style="border:1px solid #E5E5E5;">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?=base_url();?>hostel/assign_hostel2" method="post" class="horizontal-form">
											<div class="form-body">
												<br>
												<div class="row">
										...
										<?php foreach ($this->M_academic_year->get_active_academic_years() as $row) {?>
											...
											<div class="form-actions left">
												...
												<a href="<?=base_url();?>hostel/student_hostels" class="btn default green-stripe"> Back</a>
											</div>
										</form>
										<!-- END FORM-->
								</div>
