					...
					<div class="portlet box grey" style="border:1px solid #E5E5E5;">
									...
									<div class="portlet-body form">
										<!-- BEGIN FORM-->
										<form action="<?=base_url();?>term/save" method="post" class="horizontal-form">
											<div class="form-body">
												<br>
												<div class="row">
													<div class="col-md-12">
														<div class="form-group">
															...
															<input type="text" name="term" class="form-control" value="<?php if (!empty($term)){echo $term;}?>" required>
														</div>
													</div>
					...
					<option <?php if($academic_year_id == $row['academic_year_id']){ echo 'selected';}?> value="<?=$row['academic_year_id'];?>"><?=$row['academic_year'];?></option>
														<?php }?>
													</select>
														</div>
											...
											<div class="form-actions left">
												...
												<a href="<?=base_url();?>term" class="btn default green-stripe"> Back</a>
											</div>
										</form>
										<!-- END FORM-->
								</div>
