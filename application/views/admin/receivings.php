				...
				<div class="col-md-12">
					<!-- BEGIN EXAMPLE TABLE PORTLET-->
						...
						<div class="portlet-body">
							...
							<tbody>
							<?php foreach ($this->M_book->get_receivings() as $row):?>
							<tr>
								...
								<td><?=$row['comment'];?></td>
								<td>
									<a href="<?=base_url();?>book/delete_receiving/<?=$row['book_receiving_id'];?>" class="btn btn-sm default red-stripe"><i class="fa fa-times-circle"></i></a>
								</td>
